...
public class PrivateLombokGettersAndSettersDomainFactoryTest extends BaseDomainFactoryTest<PrivateLombokGettersAndSettersDomain> {
    @Override
    protected Factory<PrivateLombokGettersAndSettersDomain> createFactory() {
        return new PrivateLombokGettersAndSettersDomainFactory();
    }
