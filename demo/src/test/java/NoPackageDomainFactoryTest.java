...
public class NoPackageDomainFactoryTest extends BaseDomainFactoryTest<NoPackageDomain> {
    @Override
    protected Factory<NoPackageDomain> createFactory() {
        return new NoPackageDomainFactory();
    }
