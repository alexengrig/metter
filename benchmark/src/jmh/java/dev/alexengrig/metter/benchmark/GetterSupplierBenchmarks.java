...
//        32
        ...
        HashMap<String, Function<Domain32, Object>> handlingMap32 = new HashMap<String, Function<Domain32, Object>>(32) {{
            ...
            put("bool0", HandlingUtils.getMethod(Domain32.class, "getBool0", boolean.class));
            put("bool1", HandlingUtils.getMethod(Domain32.class, "getBool1", boolean.class));
            put("bool2", HandlingUtils.getMethod(Domain32.class, "getBool2", boolean.class));
            put("bool3", HandlingUtils.getMethod(Domain32.class, "getBool3", boolean.class));
            put("bool4", HandlingUtils.getMethod(Domain32.class, "getBool4", boolean.class));
            put("bool5", HandlingUtils.getMethod(Domain32.class, "getBool5", boolean.class));
            put("bool6", HandlingUtils.getMethod(Domain32.class, "getBool6", boolean.class));
            put("bool7", HandlingUtils.getMethod(Domain32.class, "getBool7", boolean.class));
