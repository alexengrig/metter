...
public class InheritedLombokDataDomainFactoryTest extends BaseDomainFactoryTest<InheritedLombokDataDomain> {
    @Override
    protected Factory<InheritedLombokDataDomain> createFactory() {
        return new InheritedLombokDataDomainFactory();
    }
