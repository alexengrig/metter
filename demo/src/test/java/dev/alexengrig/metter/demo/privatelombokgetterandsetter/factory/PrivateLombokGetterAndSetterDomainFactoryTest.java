...
public class PrivateLombokGetterAndSetterDomainFactoryTest extends BaseDomainFactoryTest<PrivateLombokGetterAndSetterDomain> {
    @Override
    protected Factory<PrivateLombokGetterAndSetterDomain> createFactory() {
        return new PrivateLombokGetterAndSetterDomainFactory();
    }
