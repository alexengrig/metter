...
public class PrivateGettersAndSettersDomainFactoryTest extends BaseDomainFactoryTest<PrivateGettersAndSettersDomain> {
    @Override
    protected Factory<PrivateGettersAndSettersDomain> createFactory() {
        return new PrivateGettersAndSettersDomainFactory();
    }
