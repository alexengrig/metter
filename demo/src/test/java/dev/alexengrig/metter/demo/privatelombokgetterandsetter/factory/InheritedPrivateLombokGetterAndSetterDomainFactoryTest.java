...
public class InheritedPrivateLombokGetterAndSetterDomainFactoryTest extends BaseDomainFactoryTest<InheritedPrivateLombokGetterAndSetterDomain> {
    @Override
    protected Factory<InheritedPrivateLombokGetterAndSetterDomain> createFactory() {
        return new InheritedPrivateLombokGetterAndSetterDomainFactory();
    }
