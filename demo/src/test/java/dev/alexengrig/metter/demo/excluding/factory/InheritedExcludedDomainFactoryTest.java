...
public class InheritedExcludedDomainFactoryTest extends BaseDomainFactoryTest<InheritedExcludedDomain> {

    @Override
    protected Factory<InheritedExcludedDomain> createFactory() {
        return new InheritedExcludedDomainFactory();
    }
