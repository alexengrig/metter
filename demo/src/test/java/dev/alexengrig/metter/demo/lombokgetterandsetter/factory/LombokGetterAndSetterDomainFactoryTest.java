...
public class LombokGetterAndSetterDomainFactoryTest extends BaseDomainFactoryTest<LombokGetterAndSetterDomain> {
    @Override
    protected Factory<LombokGetterAndSetterDomain> createFactory() {
        return new LombokGetterAndSetterDomainFactory();
    }
